...
class ImNegotiator
{
     ...
     * @Groups({"admin:read", "user:read", "agenda:read", "owner:read", "select-negotiator:read", "suivi:read"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=20)
     * @Groups({"admin:read", "user:read", "suivi:read"})
     */
    private $code;
     ...
     * @Groups({"admin:read", "user:read", "agenda:read", "suivi:read"})
     */
    private $email;
    ...
    /**
     * @return string
     * @Groups({"admin:read", "user:read", "agenda:read", "owner:read", "suivi:read"})
     */
