...
import { SolsItem }   from "./SolsItem";

export class SolsList extends Component {
    constructor(props) {
        super(props);
            ...
            <div>
                <div className="toolbar">
                    <div className="item create">
                        <Button onClick={() => onChangeContext("create")}>Ajouter un sol</Button>
                    </div>
                ...
                <div className="items-table">
                    <div className="items items-default">
                        ...
                        {data && data.length !== 0 ? data.map(elem => {
                            return <SolsItem {...this.props} elem={elem} key={elem.id}/>
