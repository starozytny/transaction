...
export function SolFormulaire ({ type, onChangeContext, onUpdateList, element })
{
    let title = "Ajouter un sol";
    let url = Routing.generate(URL_CREATE_ELEMENT);
    let msg = "Félicitations ! Vous avez ajouté un nouveau sol !"
...
export class SolForm extends Component {
    constructor(props) {
        super(props);
