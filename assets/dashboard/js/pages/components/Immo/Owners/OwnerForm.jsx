                                     ...
                                     negotiators })
{
    ...
    let form = <OwnerForm
        ...
        category={Formulaire.setValueToForm(element, element.category, "")}

        isCoIndivisaire={Formulaire.setValueToForm(element, element.isCoIndivisaire, 0)}
        coLastname={Formulaire.setValueToForm(element, element.coLastname, "")}
        coFirstname={Formulaire.setValueToForm(element, element.coFirstname, "")}
        coPhone={Formulaire.setValueToForm(element, element.coPhone, "")}
        coEmail={Formulaire.setValueToForm(element, element.coEmail, "")}
        coAddress={Formulaire.setValueToForm(element, element.coAddress, "")}
        coZipcode={Formulaire.setValueToForm(element, element.coZipcode, "")}
        coCity={Formulaire.setValueToForm(element, element.coCity, "")}
