...
export class ProspectsList extends Component {
    ...
    render () {
        ...
        let dropdownItems = [
            {data: <a className="item" download="prospects.xlsx" href={Routing.generate('api_prospects_export', {'format': 'excel'})}>
            ...
            <div>
                ...
                {(data && data.length !== 0) && <div className="page-actions">
                    <div className="selectors-actions">
                        {(!isClient && !isSelect) && <div className="item" onClick={onDeleteAll}>
