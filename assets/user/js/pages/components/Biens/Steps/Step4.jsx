    ...
    return <div className={"step-section" + (step === 4 ? " active" : "")}>
        <div className="line special-line">
            ...
            <div className="line line-3">
                <Input identifiant="zipcode" valeur={zipcode} errors={errors} onChange={onChange}>
            ...
            <div className="line line-3">
                <Input identifiant="departement" valeur={departement} errors={errors} onChange={onChangeZipcode}>
