            ...
            <div className="content">
                ...
                <div className="items-table">
                    <div className="items items-default">
                        ...
                        <OwnersItem isReadBien={true} isClient={true} isFormBien={false} elem={elem.owner} biens={[]}/>
                    </div>
                </div>
            </div>
        </div>
