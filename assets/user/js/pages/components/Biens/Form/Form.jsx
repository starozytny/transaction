...
export function BienFormulaire ({ type, element, rooms, photos, negotiators, allOwners, quartiers, societyId, agencyId })
{
    ...
    let form = <BienForm
        ...
        priceHorsAcquereur={element ? setValueEmptyIfNull(financial, financial.priceHorsAcquereur) : ""}
