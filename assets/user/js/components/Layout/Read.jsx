            ...
            <div className="col-2">
                ...
                <div className="item">
                    <div className="badges">
                        ...
                        {elem.status && elem.status !== null && <div className={"badge badge-" + elem.status}>{elem.statusString}</div>}
                        {elem.type && elem.type !== null && <div className="badge badge-default">Type de prospect : {elem.typeString}</div>}
                    </div>
